# ComicConLotterySimulator
Java application that will simulate the lottery that occurs in NYCC and SDCC every year. This application takes in three files:

* Lottery_Entry_Data - Contains data of each lottery entry.
